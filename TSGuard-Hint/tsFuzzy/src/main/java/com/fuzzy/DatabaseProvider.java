...
public interface DatabaseProvider<G extends GlobalState<O, ?, C>, O extends DBMSSpecificOptions<?>, C extends TSFuzzyDBConnection> {
     ...
     *
     * @param globalState the state creat                                                                                                                                                                       ed and is valid for this method call.
    ...
    void dropDatabase(G globalState) throws Exception;
