...
public abstract class GlobalState<O extends DBMSSpecificOptions<?>, S extends AbstractSchema<?, ?>, C extends TSFuzzyDBConnection> {
    ...
    public DBValResultSet executeStatementAndGet(Query<C> q, String... fills) throws Exception {
        /*ExecutionTimer timer = executePrologue(q);
        DBValResultSet result = manager.executeAndGet(q, fills);
