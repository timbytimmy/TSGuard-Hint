...
public final class Randomly {
    ...
    public static boolean getBoolean(int numerator, int denominator) {
        // 概率命中
        return getThreadRandom().get().nextInt(denominator) < numerator;
    }
    ...
    public enum StringGenerationStrategy {
        ...
        NUMERIC {
            ...
            @Override
            public String getNotBlankString(Randomly r) {
                String str;
                do {
                    str = getString(r);
        ...
        public abstract String getNotBlankString(Randomly r);
    ...
    public String getNotBlankString() {
        return stringGenerationStrategy.getNotBlankString(this);
    }
    ...
    public double getInfiniteDouble() {
        double val = getDouble();
        while (Double.isInfinite(val)) val = getDouble();
        return val;
    }
    ...
    // TSGuard previously used ThreadLocalRandom.current().nextLong(lower, upper)
