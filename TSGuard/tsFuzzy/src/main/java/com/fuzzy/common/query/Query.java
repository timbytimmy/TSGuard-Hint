...
public abstract class Query<C extends TSFuzzyDBConnection> implements Loggable {
     ...
     */
    public abstract String getUnterminatedAndNoQEqualQueryString();
    ...
    public <G extends GlobalState<?, ?, C>> DBValResultSet executeAndGet(G globalState, String... fills)
            throws Exception {
    ...
    public <G extends GlobalState<?, ?, C>> DBValResultSet executeAndGetLogged(G globalState) throws Exception {
        logQueryString(globalState);
