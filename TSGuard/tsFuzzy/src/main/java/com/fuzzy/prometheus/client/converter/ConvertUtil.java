...
import com.fuzzy.prometheus.client.converter.query.QueryDataType;
import com.fuzzy.prometheus.client.converter.series.DefaultSeriesResult;
import com.fuzzy.prometheus.client.converter.series.SeriesResultItem;
...
import com.fuzzy.prometheus.client.converter.scrapeTarget.TargetResultItem;
					...
					if("status".equals(propertyName)) {
						...
						while(reader.hasNext()) {
							...
							if("activeTargets".equals(_propertyName)) {
								...
								reader.endArray();
							} else if ("droppedTargetCounts".equals(_propertyName)) {
								targetResult.setDroppedTargetCounts(convertJsonToMap(reader));
							}
						}
						reader.endObject();
					}
